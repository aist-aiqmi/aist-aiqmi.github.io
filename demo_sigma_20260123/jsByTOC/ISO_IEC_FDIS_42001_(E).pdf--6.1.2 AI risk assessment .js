...
a)  is informed by and aligned to the AI policy (see 5.2) and AI objectives (see 6.2);
NOTE 
...
c) 
consider the controls from Annex A that are relevant for the implementation of the AI risk treatment 
options;
...
Control objectives are implicitly included in the controls chosen. The organization can select the control 
objectives and controls listed in Annex A that it needs. The Annex A controls are not exhaustive and 
additional control objectives and controls can be needed. If different or additional controls are necessary 
beyond those in Annex A, the organization can design such controls or take them from existing sources. 
AI risk management can be integrated in other management systems, if applicable.
f) 
produce a statement of applicability that contains the necessary controls [see b), c) and d)] and 
