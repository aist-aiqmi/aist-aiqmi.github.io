...
9.2.4  Overall assessment
[DP-R-BI-OA] Overall assessment
Requirement: Do
Documentation should be available that conclusively and collectively justifies that the residual risk with regard 
to the confidentiality of business-relevant information in the context of the AI application is acceptable 
in accordance with [DP-R-BI-CR-01]. In particular, justification must be provided that licensed data that is 
processed or collected in the AI application, for example for training or as input, is only used according to the 
licensing terms.
If not all requirements specified in [DP-R-BI-CR-01] are met, the deviations must be documented. 
